...
//
//(function() {
//    this.Observable = AsyncTestCase("Observable");
//
//    this.Observable.prototype.setUp = function() {
//    };
//
//    this.Observable.prototype.tearDown = function() {
//    };
//
//    this.ObservableTest.prototype.testClassDefinition = function(queue) {
//        expectAsserts(2);
//
...
//        });
//    };
//    this.Observable.prototype.testConstructionWithArray = function(queue) {
//        expectAsserts(1);
//
...
//        });
//    };
//    this.Observable.prototype.testConstructionWithArrayNoArray = function(queue) {
//        expectAsserts(1);
//
//        queuedRequire(queue, ["antie/iterator"], function(Iterator) {
//
...
//        });
//    };
//    this.Observable.prototype.testNextReturnsExpectedItems = function(queue) {
//        expectAsserts(3);
//
//        queuedRequire(queue, ["antie/iterator"], function(Iterator) {
//
...
//        });
//    };
//    this.Observable.prototype.testIsEmptyReturnsFalseWhenIteratorHasFurtherItems = function(queue) {
//        expectAsserts(1);
//
//        queuedRequire(queue, ["antie/iterator"], function(Iterator) {
//
...
//        });
//    };
//    this.Observable.prototype.testIsEmptyReturnsTrueWhenIteratorIsEmpty = function(queue) {
//        expectAsserts(1);
//
//        queuedRequire(queue, ["antie/iterator"], function(Iterator) {
//
...
//        });
//    };
//    this.Observable.prototype.testNextReturnsUndefinedWhenEmpty = function(queue) {
//        expectAsserts(2);
//
//        queuedRequire(queue, ["antie/iterator"], function(Iterator) {
//
...
//    };
//
//    this.Observable.prototype.testGetPointer = function(queue) {
//        expectAsserts(2);
//
//        queuedRequire(queue, ["antie/iterator"], function(Iterator) {
//
...
//    };
//
//    this.Observable.prototype.testReset = function(queue) {
//        expectAsserts(3);
//
//        queuedRequire(queue, ["antie/iterator"], function(Iterator) {
//
